...
import com.amilesend.tvdb.client.model.InlineResponse20052;
...
public class UpdatesApi {
     ...
     */
    public okhttp3.Call updatesCall(BigDecimal since, String type, String action, BigDecimal page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/updates";
    ...
    private okhttp3.Call updatesValidateBeforeCall(BigDecimal since, String type, String action, BigDecimal page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'since' is set
        if (since == null) {
            throw new ApiException("Missing the required parameter 'since' when calling updates(Async)");
        }

        okhttp3.Call call = updatesCall(since, type, action, page, progressListener, progressRequestListener);
        return call;
    ...
    public InlineResponse20052 updates(BigDecimal since, String type, String action, BigDecimal page) throws ApiException {
        ApiResponse<InlineResponse20052> resp = updatesWithHttpInfo(since, type, action, page);
        return resp.getData();
    }
    ...
    public ApiResponse<InlineResponse20052> updatesWithHttpInfo(BigDecimal since, String type, String action, BigDecimal page) throws ApiException {
        okhttp3.Call call = updatesValidateBeforeCall(since, type, action, page, null, null);
     ...
     */
    public okhttp3.Call updatesAsync(BigDecimal since, String type, String action, BigDecimal page, final ApiCallback<InlineResponse20052> callback) throws ApiException {
        ...
        okhttp3.Call call = updatesValidateBeforeCall(since, type, action, page, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse20052>(){}.getType();
