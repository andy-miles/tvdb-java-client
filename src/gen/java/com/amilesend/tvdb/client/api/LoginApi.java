...
public class LoginApi {
     ...
     */
    public okhttp3.Call loginPostCall(LoginBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call loginPostValidateBeforeCall(LoginBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling loginPost(Async)");
        }

        okhttp3.Call call = loginPostCall(body, progressListener, progressRequestListener);
        return call;
    ...
    public InlineResponse200 loginPost(LoginBody body) throws ApiException {
        ApiResponse<InlineResponse200> resp = loginPostWithHttpInfo(body);
        return resp.getData();
    }
    ...
    public ApiResponse<InlineResponse200> loginPostWithHttpInfo(LoginBody body) throws ApiException {
        okhttp3.Call call = loginPostValidateBeforeCall(body, null, null);
     ...
     */
    public okhttp3.Call loginPostAsync(LoginBody body, final ApiCallback<InlineResponse200> callback) throws ApiException {
        ...
        okhttp3.Call call = loginPostValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse200>(){}.getType();
