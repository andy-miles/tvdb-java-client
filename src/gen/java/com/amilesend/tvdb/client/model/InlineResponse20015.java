...
import com.amilesend.tvdb.client.model.Country;
...
public class InlineResponse20015 {
  ...
  public InlineResponse20015 data(List<Country> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20015 addDataItem(Country dataItem) {
    if (this.data == null) {
