...
public class InlineResponse20026 {
  @SerializedName("data")
  private List<ListBaseRecord> data = null;
  ...
  public InlineResponse20026 data(List<ListBaseRecord> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20026 addDataItem(ListBaseRecord dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<ListBaseRecord>();
    }
  ...
  **/
  @Schema(description = "")
  public List<ListBaseRecord> getData() {
    return data;
  }

  public void setData(List<ListBaseRecord> data) {
    this.data = data;
  }
  ...
  **/
  ...
  public InlineResponse20026 links(Links links) {
    this.links = links;
    return this;
  }
