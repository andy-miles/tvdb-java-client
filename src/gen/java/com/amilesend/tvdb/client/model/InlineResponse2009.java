...
import com.amilesend.tvdb.client.model.AwardCategoryExtendedRecord;
...
public class InlineResponse2009 {
  @SerializedName("data")
  private AwardCategoryExtendedRecord data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse2009 data(AwardCategoryExtendedRecord data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public AwardCategoryExtendedRecord getData() {
    return data;
  }

  public void setData(AwardCategoryExtendedRecord data) {
    this.data = data;
  }
