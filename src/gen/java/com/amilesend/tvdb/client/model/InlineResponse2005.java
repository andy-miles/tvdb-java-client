...
public class InlineResponse2005 {
  @SerializedName("data")
  private List<AwardBaseRecord> data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse2005 data(List<AwardBaseRecord> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2005 addDataItem(AwardBaseRecord dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<AwardBaseRecord>();
    }
  ...
  **/
  @Schema(description = "")
  public List<AwardBaseRecord> getData() {
    return data;
  }

  public void setData(List<AwardBaseRecord> data) {
    this.data = data;
  }
