...
import com.amilesend.tvdb.client.model.Language;
...
public class InlineResponse20025 {
  ...
  public InlineResponse20025 data(List<Language> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20025 addDataItem(Language dataItem) {
    if (this.data == null) {
