...
public class InlineResponse2003 {
  @SerializedName("data")
  private List<ArtworkStatus> data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse2003 data(List<ArtworkStatus> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2003 addDataItem(ArtworkStatus dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<ArtworkStatus>();
    }
  ...
  **/
  @Schema(description = "")
  public List<ArtworkStatus> getData() {
    return data;
  }

  public void setData(List<ArtworkStatus> data) {
    this.data = data;
  }
