...
import com.amilesend.tvdb.client.model.EntityType;
...
public class InlineResponse20016 {
  @SerializedName("data")
  private List<EntityType> data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse20016 data(List<EntityType> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20016 addDataItem(EntityType dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<EntityType>();
    }
