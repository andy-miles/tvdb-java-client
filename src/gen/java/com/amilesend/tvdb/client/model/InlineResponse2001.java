...
public class InlineResponse2001 {
  @SerializedName("data")
  private ArtworkBaseRecord data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse2001 data(ArtworkBaseRecord data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public ArtworkBaseRecord getData() {
    return data;
  }

  public void setData(ArtworkBaseRecord data) {
    this.data = data;
  }
