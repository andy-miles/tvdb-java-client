...
import com.amilesend.tvdb.client.model.CompanyType;
...
public class InlineResponse20012 {
  @SerializedName("data")
  private List<CompanyType> data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse20012 data(List<CompanyType> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20012 addDataItem(CompanyType dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CompanyType>();
    }
  ...
  **/
  ...
  public void setData(List<CompanyType> data) {
    this.data = data;
  }
