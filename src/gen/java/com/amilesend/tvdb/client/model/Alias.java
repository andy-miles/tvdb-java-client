 ...
 */
@Schema(description = "An alias model, which can be associated with a series, season, movie, person, or list.")
...
public class Alias {
   ...
   * @return language
  **/
  @Schema(description = "A 3-4 character string indicating the language of the alias, as defined in Language.")
   ...
   * @return name
  **/
  @Schema(description = "A string containing the alias itself.")
