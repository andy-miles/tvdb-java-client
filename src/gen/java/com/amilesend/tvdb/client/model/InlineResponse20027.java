...
public class InlineResponse20027 {
  @SerializedName("data")
  private ListBaseRecord data = null;

  @SerializedName("status")
  private String status = null;

  public InlineResponse20027 data(ListBaseRecord data) {
    this.data = data;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public ListBaseRecord getData() {
    return data;
  }

  public void setData(ListBaseRecord data) {
    this.data = data;
  }
