 ...
 */
@Schema(description = "base award category record")
...
public class AwardCategoryBaseRecord {
  ...
  public AwardCategoryBaseRecord allowCoNominees(Boolean allowCoNominees) {
  ...
  **/
  ...
  public AwardCategoryBaseRecord award(AwardBaseRecord award) {
    this.award = award;
    return this;
  }
  ...
  **/
  ...
  public AwardCategoryBaseRecord forMovies(Boolean forMovies) {
  ...
  **/
  ...
  public AwardCategoryBaseRecord forSeries(Boolean forSeries) {
  ...
  **/
  ...
  public AwardCategoryBaseRecord id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public AwardCategoryBaseRecord name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AwardCategoryBaseRecord awardCategoryBaseRecord = (AwardCategoryBaseRecord) o;
    return Objects.equals(this.allowCoNominees, awardCategoryBaseRecord.allowCoNominees) &&
        Objects.equals(this.award, awardCategoryBaseRecord.award) &&
        Objects.equals(this.forMovies, awardCategoryBaseRecord.forMovies) &&
        Objects.equals(this.forSeries, awardCategoryBaseRecord.forSeries) &&
        Objects.equals(this.id, awardCategoryBaseRecord.id) &&
        Objects.equals(this.name, awardCategoryBaseRecord.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowCoNominees, award, forMovies, forSeries, id, name);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwardCategoryBaseRecord {\n");
